...
<section id="main">
    ...
    <p style="text-align:center;">
        ...
        ?>        
		<?php
        if (isset($params['vd_errcgu'])) {
            ?>
            <strong class="err">
                    <br />
                    <br />
                    Merci de valider les conditions générales.
					<br />Please accept the legal terms.
            </strong>
            <?php
        }
        ?>
        <br /><br />
        <em>Le code d'accès est disponible à la réception.<br />
        The access code is available at the reception desk.</em>
    </p>
...
13600 La Ciotat
        ...
        <p style="text-align: center;">
            <input type="checkbox" name="CGU" id="CGU" value="OK" checked /> <label for="CGU">J'accepte les <a href="#" onclick="showCGU(); return false;">Conditions Générales d'Utilisation</a>.</label>
        </p>
        <div class="spacer"></div>
        <p style="text-align: center;">
