...
28100 DREUX
        ...
        <p>
            <input type="checkbox" name="CGU" id="CGU" value="OK"<?php if (isset($params['vd_errcode'])) echo " checked=checked ";?>/> <label for="CGU">J'accepte les Conditions Générales d'Utilisation.</label>
        </p>
        <div class="spacer"></div>
        <p style="text-align: center;">
