...
Les présentes Conditions d’Utilisation sont soumises au droit français et les parties attribuent une compétence non exclusive aux juridictions française. Seul le droit français est applicable.
...
Hotel VH Paris
        ...
        <p>
            <input type="checkbox" name="CGU" id="CGU" value="OK" /> <label for="CGU" class="coquette">J'accepte les Conditions Générales d'Utilisation.</label>
        </p>
        <div class="spacer"></div>
