...
<section id="main">
    ...
    <p style="text-align:center;">
        <label for="vd_code"><strong>Mot de passe Wifi / Wifi Password : </strong></label><input type="text" value="" id="vd_code" name="vd_code" style="width: 100px;" />
        <?php
        if (isset($params['vd_errcode'])) {
            ?>
            <div class="err">
                    Merci d'entrer un mot de passe wifi valide.<br />
                    Please enter a valid wifi password.
            </div>
            <?php
		} else
		if (preg_match('/^no more sess/i', $params['error'])) {
            ?>
            <div class="err">
                    Attention, trop d'appareils sont déjà connectés avec ce mot de passe.
					Pour connecter un nouvel appareil, déconnectez un des autres et attendez 5 minutes.
            </div>
            <?php
		}
        ?>
        ...
        <br /><br />
        <em>Le mot de passe wifi peut être obtenu à la réception.<br />
        Please ask reception for the wifi password.</em>
    </p>
    <div class="spacer"></div>

    <div style="text-align: center">
            <img class="logo" src="<?php echo $W['images']; ?>/demoCode.png" width="350" />
    </div>
    <div class="spacer"></div>
