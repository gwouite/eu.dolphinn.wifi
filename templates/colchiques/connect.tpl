...
<section id="main">
    ...
    <input type="hidden" value="les colchiques" id="vd_code" name="vd_code" style="width: 100px;" />
    <!-- <p style="text-align:center;">
        <label for="vd_code"><strong>Code d'accès / Access code : </strong></label><input type="text" value="les colchiques" id="vd_code" name="vd_code" style="width: 100px;" />
        <?php
    ...
    <p>
        Merci d'accepter les conditions générales d'utilisation ci-dessous afin de vous connecter à internet.
    </p>
    <p class="alt">
        Please accept the legal terms below to access the internet.
    </p>
