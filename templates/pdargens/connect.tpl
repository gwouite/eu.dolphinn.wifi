...
13600 La Ciotat
        ...
        <p style="text-align: center;">
            <input type="checkbox" name="CGU" id="CGU" value="OK" /> <label for="CGU">J'accepte les <a href="#" onclick="showCGU(); return false;">Conditions Générales d'Utilisation</a>.</label>
        </p>
        <div class="spacer"></div>
        <p style="text-align: center;">
