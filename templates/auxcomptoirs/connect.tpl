...
?>
<form name="frmMk" action="login?<?php echo $params_query; ?>" method="post">
<section id="main">
		...
		<table style="margin: auto; width: 300px;">
			<tr>
				<td style="text-align: right">
					<label for="vd_email"><strong>Email* : </strong></label></td>
				<td>
					<input type="email" value="<?php echo str_replace('"','',$_REQUEST['vd_email']); ?>" id="vd_email" name="vd_email" style="width: 150px;" /></td>
			</tr>
			<tr>
				<td style="text-align: right">
					<label for="vd_code"><strong>Code d'accès<!-- / Access code --> : </strong></label></td>
				<td>
					<input type="text" value="" id="vd_code" name="vd_code" style="width: 150px;" /></td>
			</tr>
		</table>
	</p>
    <p style="text-align:center;">
        <?php
        if (isset($params['vd_erremail'])) {
            ?>
            <strong class="err">
                    <br />
        ...
        if (isset($params['vd_errcode'])) {
            ...
            <strong class="err">
                    <br />
                    Merci d'entrer un code d'accès valide.
					<!-- <br />
        ...
        ?>
        <br />
        <em>Le code d'accès est disponible<br />auprès de votre serveur.</em>
        <!-- Ask your waiter/waitress for the access code.</em> -->
    </p>
    <pre class="conditions" id="Conditions">Conditions générales d'utilisation du service Hotspot WiFi
...
Les présentes Conditions d’Utilisation sont soumises au droit français et les parties attribuent une compétence non exclusive aux juridictions françaises. Seul le Droit Français est applicable.
...
28000 Chartres
        ...
        <p style="text-align: center;">
            <input type="checkbox" name="CGU" id="CGU" value="OK" checked="checked" /> <label for="CGU">J'accepte les <a href="#" onclick="showCGU(); return false;">Conditions Générales d'Utilisation</a>.</label><br />
            <br /><sup>*</sup> : En entrant votre email, vous acceptez de recevoir des<br />informations de la part de votre restaurant. C'est optionnel.
        </p>
        <div class="spacer"></div>
        <p style="text-align: center;">
            <input type="submit" class="bt" name="vd_balid" onclick="return validCGU()" style="background-color: #005aa7; color: #ffffff; border-color: #ffffff; padding: 15px; padding-left: 65px; padding-right: 65px;" value="Connexion" />
        </p>
    </div>
</section>
</form>
